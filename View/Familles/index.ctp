...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title">
            Gestion des Produits <small>Liste des Familles</small>
        </h3>
        ...
        <button type="button" class="btn blue" onclick="document.location.href = '<?php echo $this->Html->url(array('controller' => 'familles', 'action' => 'edit')); ?>';">
            Ajouter une Famille <i class="fa fa-plus-circle"></i>
        </button>
    ...
    <div class="col-md-12">
        <div class="portlet box light-grey">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-users"></i><?php echo __('Liste des Familles'); ?>
                </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="ProductsListe">
                    ...
                    <tbody>
                        <?php foreach ($familles as $famille): ?>
                            <tr class="odd gradeX">
                                <td><?php echo $famille['Famille']['name'] ?></td>
                                <td>
                                    <a href="<?php echo $this->Html->url(array('controller' => 'familles', 'action' => 'edit',$famille['Famille']['id'])); ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                                    <a class="btn btn-danger"  data-toggle="modal" href="#responsive" onclick="$('#delete').attr('onclick','document.location.href=\'<?php echo $this->Html->url(array('controller' => 'familles', 'action' => 'delete',$famille['Famille']['id']),true); ?>\'');"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
